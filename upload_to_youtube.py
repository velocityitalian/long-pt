"""
YouTube Upload Script for Velocity Portuguese
"""
...
def upload_to_youtube(video_info):
    ...
    title = "Learn Portuguese with Velocity Portuguese"
    description = ""
    ...
    video_metadata = {
        "snippet": {"title": title, "description": description[:4800],
                     "tags": ["Learn Portuguese", "Portuguese Phrases", "Portuguese Language", "Velocity Portuguese", "Portuguese for Beginners"],
                     "categoryId": "27"},
...
def main():
    print("VELOCITY PORTUGUESE - YOUTUBE UPLOADER")
