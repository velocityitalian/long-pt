...
SCENIC_STYLES = [
    "stunning Portuguese woman in traditional dress, Lisbon, sunset over Tagus river",
    "elegant Brazilian woman in summer dress, Rio de Janeiro, Sugarloaf Mountain",
    "beautiful Portuguese woman in traditional outfit, Porto, Douro Valley vineyards",
    "Portuguese girl at Praia da Marinha beach, Algarve, golden hour",
    "gorgeous Brazilian woman in modern wear, Copacabana beach sunset",
    "beautiful Portuguese woman, Sintra Palace, warm light",
    "Brazilian woman in traditional attire, Salvador, palm trees",
    "elegant Portuguese woman, Azores islands, zen atmosphere",
]


def generate_scenic_image(category_english: str, category_portuguese: str, output_path: str):
    # Try pre-made thumbnail first
    premade = get_thumbnail("Portuguese", category_english)
    if premade:
        return premade
        ...
        for attempt in range(3):
            ...
            prompt = (
                f"Professional YouTube thumbnail for Portuguese language learning video. "
                f"{style}. "
                ...
                f"At top: '120 PORTUGUESE PHRASES'. In center: '{category_english}'. "
                f"At bottom: 'VELOCITY PORTUGUESE'. Also: '10 MINUTE LESSON' badge."
            )
            try:
    ...
    draw.text((960, 180), "120 PORTUGUESE PHRASES", fill=(255, 210, 0), font=f_big, anchor="mm")
